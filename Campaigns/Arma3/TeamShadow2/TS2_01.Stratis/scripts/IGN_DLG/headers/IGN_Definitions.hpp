...
// Directory macro
#define IGN_DLG_DIR "scripts\IGN_DLG\internal\IGN_DLG_raiseEvent.sqf"

#define IGN_DLG_DIR_DISPLAY "scripts\IGN_DLG\internal\IGN_DLG_raiseEventDisplay.sqf"

#define ctrlOnCanDestroy \
	onCanDestroy = ['IGN_Event_onCanDestroy', [ctrlParent (_this select 0), _this select 0, _this select 1], true] call compile preprocessFileLineNumbers IGN_DLG_DIR

#define displayOnLoad \
	onLoad = ['IGN_Event_onLoadDisplay', _this, ctrlIDD (_this select 0)] call compile preprocessFileLineNumbers IGN_DLG_DIR_DISPLAY

#define displayOnUnload \
	onUnload = ['IGN_Event_onUnloadDisplay', _this, ctrlIDD (_this select 0)] call compile preprocessFileLineNumbers IGN_DLG_DIR_DISPLAY
