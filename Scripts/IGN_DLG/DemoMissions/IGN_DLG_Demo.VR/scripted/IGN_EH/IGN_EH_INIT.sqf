...
#ifdef IGN_LIB_DEBUG
diag_log text "IGN_EH: Building library with DEBUG = true";
#else
diag_log text "IGN_EH: Building library with DEBUG = false";
#endif
...
_LIB_PATH = param[0, "IGN_EH", [""]];	// if path parameter not provided, assume default build path of \Mission\IGN_EH
