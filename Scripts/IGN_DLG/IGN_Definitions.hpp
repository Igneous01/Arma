...
#define ctrlOnButtonUp \
	onButtonUp = "['IGN_Event_onButtonUp', [ctrlParent (_this select 0), _this select 0]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseEnter \
	onMouseEnter = "['IGN_Event_onMouseEnter', [ctrlParent (_this select 0), _this select 0]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseExit \
	onMouseExit = "['IGN_Event_onMouseExit', [ctrlParent (_this select 0), _this select 0]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnSetFocus \
	onSetFocus = "['IGN_Event_onSetFocus', [ctrlParent (_this select 0), _this select 0]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnKillFocus \
	onKillFocus = "['IGN_Event_onKillFocus', [ctrlParent (_this select 0), _this select 0]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnTimer \
	onTimer = "['IGN_Event_onTimer', [ctrlParent (_this select 0), _this select 0]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnLBDrop \
	onLBDrop = "['IGN_Event_onLBDrop', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnKeyDown \
	onKeyDown = "['IGN_Event_onKeyDown', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2, _this select 3, _this select 4]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnKeyUp \
	onKeyUp = "['IGN_Event_onKeyUp', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2, _this select 3, _this select 4]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnChar \
	onChar = "['IGN_Event_onChar', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseButtonDown \
	onMouseButtonDown = "['IGN_Event_onMouseButtonDown', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2, _this select 3, _this select 4, _this select 5, _this select 6]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseButtonUp \
	onMouseButtonUp = "['IGN_Event_onMouseButtonUp', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2, _this select 3, _this select 4, _this select 5, _this select 6]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseButtonClick \
	onMouseButtonClick = "['IGN_Event_onMouseButtonClick', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2, _this select 3, _this select 4, _this select 5, _this select 6]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseButtonDblClick \
	onMouseButtonDblClick = "['IGN_Event_onMouseButtonDblClick', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2, _this select 3, _this select 4, _this select 5, _this select 6]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseMoving \
	onMouseMoving = "['IGN_Event_onMouseMoving', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2, _this select 3]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseHolding \
	onMouseHolding = "['IGN_Event_onMouseHolding', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2, _this select 3]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnMouseZChanged \
	onMouseZChanged = "['IGN_Event_onMouseZChanged', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnCanDestroy \
	onCanDestroy = "['IGN_Event_onCanDestroy', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'; true;"

#define ctrlOnDestroy \
	onDestroy = "['IGN_Event_onDestroy', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnIMEChar \
	onIMEChar = "['IGN_Event_onIMEChar', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnIMEComposition \
	onIMEComposition = "['IGN_Event_onIMEComposition', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnJoystickButton \
	onJoystickButton = "['IGN_Event_onJoystickButton', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnLBSelChanged \
	onLBSelChanged = "['IGN_Event_onLBSelChanged', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnLBListSelChanged \
	onLBListSelChanged = "['IGN_Event_onLBListSelChanged', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnLBDblClick \
	onLBDblClick = "['IGN_Event_onLBDblClick', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnLBDrag \
	onLBDrag = "['IGN_Event_onLBDrag', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnLBDragging \
	onLBDragging = "['IGN_Event_onLBDragging', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnCheckBoxesSelChanged \
	onCheckBoxesSelChanged = "['IGN_Event_onCheckBoxesSelChanged', [ctrlParent (_this select 0), _this select 0, _this select 1, _this select 2]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnSliderPosChanged \
	onSliderPosChanged = "['IGN_Event_onSliderPosChanged', [ctrlParent (_this select 0), _this select 0, _this select 1]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"

#define ctrlOnVideoStopped \
	onVideoStopped = "['IGN_Event_onVideoStopped', [ctrlParent (_this select 0), _this select 0]] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEvent.sqf'"
...
class ignDisplay
{
	onLoad = "['IGN_Event_onLoad', _this] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEventDisplay.sqf'; true;";
	onUnload = "['IGN_Event_onUnload', _this] execVM 'scripted\IGN_DLG\IGN_DLG_raiseEventDisplay.sqf'; true;";
};