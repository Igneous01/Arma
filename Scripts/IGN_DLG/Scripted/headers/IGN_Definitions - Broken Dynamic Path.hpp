...
class ignDisplay
{
	onLoad = '[''IGN_Event_onLoadDisplay'', _this, ctrlIDD (_this select 0)] execVM ''IGN_DLG_DIR_Display''';
	onUnload = '[''IGN_Event_onUnloadDisplay'', _this, ctrlIDD (_this select 0)] execVM ''IGN_DLG_DIR_Display''';
};