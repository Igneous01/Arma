...
#define IGN_DLG_Template_ToolTipColorText { Dlg_Color_Silver, 1 }
#define IGN_DLG_Template_ToolTipColorBox { Dlg_Color_DkGray, 1 }
#define IGN_DLG_Template_ToolTipColorShade { Dlg_Color_Black, 0.65 }
#define IGN_DLG_Template_ColorText { Dlg_Color_Silver, 1 }
#define IGN_DLG_Template_ColorBackground { Dlg_Color_DkGray, 1 }
...
//*******************************
#define IGN_DLG_Template_ColorBackground2 { Dlg_Color_LtGray, 0.65 }
#define IGN_DLG_Template_ColorSecondary { Dlg_Color_DkGray, 0.65 }
#define IGN_DLG_Template_ColorFocusedSecondary { Dlg_Color_LtGray, 0.65 }
#define IGN_DLG_Template_Color2Secondary { Dlg_Color_DkGray, 0.65 }
...
#define IGN_DLG_Template_ColorSelect { Dlg_Color_Black, 1 }

// Text selection color (oscillates between this and colorSelect) - used in combobox / listbox
#define IGN_DLG_Template_ColorSelect2 { Dlg_Color_Black, 1 }

// Selected item fill color
#define IGN_DLG_Template_ColorSelectBackground {Dlg_Color_DkGray,0.7}

// Selected item fill color (oscillates between this and colorSelectBackground) - used in combobox / listbox
#define IGN_DLG_Template_ColorSelectBackground2 {Dlg_Color_LtGray,0.7}
...
#define IGN_DLG_Template_ColorEnabled { Dlg_Color_DkGray, 0.25 }
#define IGN_DLG_Template_ColorChecked { Dlg_Color_LtGray, 0.25 }
#define IGN_DLG_Template_ColorBorder { Dlg_Color_Black, 0.25 }
#define IGN_DLG_Template_ColorSeparator { Dlg_Color_DkGray, 0.25 }

// Used in scrollbar, slider
#define IGN_DLG_Template_Color { Dlg_Color_DkGray, 0.6 }
#define IGN_DLG_Template_Color2 { Dlg_Color_LtGray, 0.6 }

// used by scroll, slider, combo, list
#define IGN_DLG_Template_ColorActive { Dlg_Color_DkGray, 1 }
...
#define IGN_DLG_Template_ColorSelection { Dlg_Color_Black, 0.75 }
...
#define IGN_DLG_Template_ColorBackgroundActive { Dlg_Color_LtGray, 0.5 }
...
#define IGN_DLG_Template_ColorFocused { Dlg_Color_LtGray, 0.5 }
