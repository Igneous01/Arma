...
{
	obj_PilotSEAD sideChat "Shadow, this is cowboy 1-1. SEAD package enroute to strike positions. ETA 5 Mikes.";
	sleep 5;

	obj_PilotSEAD sideChat "Shadow, this is cowboy 1-1. Releasing weapons. Impact imminent.";
	sleep 5;
